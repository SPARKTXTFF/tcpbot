import os , requests , psutil , sys , jwt , pickle , json , binascii , time , urllib3 , base64 , datetime , re , socket , threading , ssl , pytz , aiohttp , asyncio
...
from Pb2 import PorTs_pb2 , MajoRLoGinrEq_pb2 , sQ_pb2 , Team_msg_pb2
                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅ AP TCP BOT ONLINE! UID: {uid}"
...
[00CED1]DEV: SPARK TXT"""
                            ...
                            try:
                                ...
                                fallback_msg = "[FF0000]AP TCP BOT online! Use /help"
                        ...
                        if inPuTMsG.startswith('/stop') and is_admin(uid):
                            ...
                            stop_msg = f"[FF0000]AP TCP BOT stopping..."
...
async def MaiiiinE():
    ...
    Uid , Pw = '4351207831','7857FB7AE3C67AEC15F0F6D6ADA868878D3D6B208BAEBC3DCE8FC9DD2695532C'
    ...
    print(f" - DEV: Ap DEVELOPER | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}")    
